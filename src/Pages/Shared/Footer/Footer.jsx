        ...
        <footer>
            <div className="footer-main">
                <div className="footer-overlay">
                    <div className="grid md:grid-cols-2 bg-[#0b1315] text-neutral-content">
                        <aside className="text-center p-10 hover:bg-slate-800 md:border-r-2 border-b-2 md:border-r-yellow-600 md:border-b-0 border-b-yellow-600">
