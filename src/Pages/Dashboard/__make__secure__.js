 ...
 *          BASIC
 * -------------------------
 * 1.do not show the link to them who should not see it only show the link the person/types who should see it 
 * 2.Do not allow to visit the link by typing on the url. use Admin that will check whether the user is admin or not 
